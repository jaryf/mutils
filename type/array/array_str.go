...
func NewStrArray(safe ...bool) *StrArray {
	return NewStrArraySize(0, 0)
}

func NewStrArraySize(size int, cap int) *StrArray {
	return &StrArray{
		mu:    new(sync.RWMutex),
...
func NewStrArrayFrom(array []string) *StrArray {
	return &StrArray{
		mu:    new(sync.RWMutex),
		array: array,
	}
...
func NewStrArrayFromCopy(array []string) *StrArray {
