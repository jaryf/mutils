...
func NewIntArray() *IntArray {
	return NewIntArraySize(0, 0)
}

func NewIntArraySize(size int, cap int) *IntArray {
	return &IntArray{
		mu:    new(sync.RWMutex),
...
func NewIntArrayRange(start, end, step int) *IntArray {
	if step == 0 {
	...
	return NewIntArrayFrom(slice)
}

func NewIntArrayFrom(array []int) *IntArray {
	return &IntArray{
		mu:    new(sync.RWMutex),
		array: array,
	}
...
func NewIntArrayFromCopy(array []int) *IntArray {
...
func (a *IntArray) Merge(array []int) *IntArray {
